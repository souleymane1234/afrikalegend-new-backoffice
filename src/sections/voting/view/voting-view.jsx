...
export default function VotingView() {
  ...
  const columnsParticulier = [
    ...
    },
    {
      ...
      key: 'resume',
      render: (_, userData) => (
        <PDFDownloadLink document={<CVDocument userData={userData} />} fileName={`CV_GENERATE_${userData.fullName}.pdf`}>
  ...
  return (
    <Container maxWidth="xl">
      <Typography variant="h4" sx={{ mb: 2 }}>Liste des postulants</Typography>

      {!isFetching && (
        <>
          <Table dataSource={allParticulier} columns={columnsParticulier}/>
          <Typography variant="h4" sx={{ my: 2 }}>Liste des entreprises</Typography>
