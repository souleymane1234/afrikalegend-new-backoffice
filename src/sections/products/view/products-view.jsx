  ...
  return (
    <Container>
      ...
      >
          ...
          <FormControlLabel control={<Switch checked={isDisplay} onChange={toogleDisplayFormation} color="warning" />} label={isDisplay ? 'Actif': 'Inactif' } />
          {/* <ProductSort />
           */}
           <Button variant="contained" onClick={async (e)=> {
            e.preventDefault();
            await deleteFormation({_id: formation?._id})
            }} color='error' startIcon={<Iconify icon="ic:twotone-delete" />}>
